...
public class MainMatrices {
	...
	public static void main(String[] args) {
		...
		// 3 declarar una matriz miMatriz de long 2 filas y 4 columnas 
		long miMatriz[][] = new long [2][4];
		
		// 4 declarar una matriz miMatriz1 de long 1 filas y 2 columnas
		// y asignar a la posicion [0][0] el valor de2,
